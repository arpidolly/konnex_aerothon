<?php if (function_exists('wc_get_product') && (is_cart() || is_shop() || is_product())) { the_content(); } else { ?><?php global $wp_query;
 ?>
<?php $skip_min_height = false; ?><section class="u-align-center u-clearfix u-section-1" id="sec-2282">
      ...
      <div class="u-container-layout u-valign-middle u-container-layout-1"><!--blog_post_image-->
        ...
        <div class="u-blog-control u-metadata u-metadata-1"><!--blog_post_metadata_date-->
          ...
          <?php if (comments_open()): ?><span class="u-meta-comments u-meta-icon"><a class="u-textlink" href="<?php echo get_comments_link(); ?>">
                                        <?php _e(sprintf(__('Comments (%d)', 'airbus_website'), (int)get_comments_number())); ?>
